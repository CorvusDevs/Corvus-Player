...
SIGNING_IDENTITY="Developer ID Application: REDACTED_IDENTITY"
TEAM_ID="REDACTED_TEAM"
...
Setup (one-time, already done):
  xcrun notarytool store-credentials "$KEYCHAIN_PROFILE" \\
    --key ~/.appstoreconnect/AuthKey_REDACTED.p8 \\
    --key-id REDACTED_KEY --issuer REDACTED_ISSUER
